    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <Popover content={emiFormulaContent} title={null} trigger="hover">
          <div className="cursor-help flex flex-col gap-1 p-4.5 rounded-xl bg-[var(--card-bg)] border border-[var(--card-border)] shadow-sm hover:border-[var(--primary)] transition-all">
        ...
        <Tooltip title="Total interest accumulated over the full tenure." trigger="hover">
          <div className="cursor-help flex flex-col gap-1 p-4.5 rounded-xl bg-[var(--card-bg)] border border-[var(--card-border)] shadow-sm hover:border-[var(--interest-color)] transition-all">
            <span className="text-[10px] font-bold text-[var(--text-muted)] tracking-wider uppercase flex items-center gap-1">
        ...
        <Tooltip title="The sum of principal and interest payable over the loan term." trigger="hover">
          <div className="cursor-help flex flex-col gap-1 p-4.5 rounded-xl bg-[var(--card-bg)] border border-[var(--card-border)] shadow-sm hover:border-[var(--text-primary)] transition-all">
            <span className="text-[10px] font-bold text-[var(--text-muted)] tracking-wider uppercase flex items-center gap-1">
      ...
      <div className="p-4.5 rounded-xl bg-[var(--card-bg)] border border-[var(--card-border)] shadow-sm">
        <Descriptions
      ...
      <div className="p-4.5 rounded-xl bg-[var(--card-bg)] border border-[var(--card-border)] shadow-sm flex flex-col gap-3.5">
