...
import { Card, Slider, Button, Badge } from "antd";
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {results.map((res, index) => {
          ...
          const cardContent = (
            <Card
              title={<span className="text-xs font-bold uppercase tracking-wider">{res.name}</span>}
              size="small"
              variant="outlined"
            ...
            >
              ...
              <div className="flex flex-col gap-2 p-3 rounded-lg bg-[var(--input-bg)] mt-4">
                ...
                <div className="flex justify-between items-center text-[10px] font-bold">
                  ...
                  <span className="text-[var(--interest-color)] font-mono">
                    {formatCurrency(res.totalInterest)}
                  </span>
                </div>
                <div className="flex justify-between items-center text-[10px] font-bold border-t border-[var(--card-border)] pt-2 mt-0.5">
